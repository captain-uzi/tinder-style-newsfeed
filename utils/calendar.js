...
const FOOTER_HEIGHT = height * 0.07;
...
const CART_BAR_HEIGHT = height * 0.1;
const CART_HEIGHT = height * 0.78;
const CART_MIN_HEIGHT = height * 0.05;
const LIST_CARD = (CART_HEIGHT - CART_BAR_HEIGHT) * 0.19;
const RIGHT_ACTION_WIDTH = 80;
const LEFT_ACTION_WIDTH = 130;
const CDCARD_WIDTH = width * 0.7;
